...
interface OneDayReminderEmailProps {
...
export const OneDayReminderEmail = ({
  userFirstName = 'Investor',
  investments = mockInvestments,
  appBaseUrl = defaultBaseUrl,
}: OneDayReminderEmailProps) => {
  ...
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Preview>Urgent: Investment Expiring Tomorrow!</Preview>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            This is an urgent notification to inform you that you have{' '}
            {investments.length === 1 ? 'an investment ' : 'investments '}{' '}
            <span style={timeframeStyle}>expiring tomorrow</span>.
          </Text>
          <Text style={paragraph}>
            Review these details promptly to ensure a seamless transition or
            reinvestment.
...
export default OneDayReminderEmail;
