...
interface SevenDayReminderEmailProps {
...
export const SevenDayReminderEmail = ({
  userFirstName = 'Investor',
  investments = mockInvestments,
  appBaseUrl = defaultBaseUrl,
}: SevenDayReminderEmailProps) => {
  ...
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Preview>Your 7-day investment expiration reminder</Preview>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            ...
            <span style={timeframeStyle}>expire in exactly 7 days</span>{' '}
            from the date this reminder was sent, which was{' '}
            <span style={todayDateStyle}>
              {new Date().toLocaleDateString('en-US', {
                year: 'numeric',
...
export default SevenDayReminderEmail;
